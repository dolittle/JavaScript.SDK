...
export { EmbeddingAlreadyHasARemoveDecorator } from './EmbeddingAlreadyHasARemoveDecorator';
export { EmbeddingAlreadyHasARemoveMethod } from './EmbeddingAlreadyHasARemoveMethod';
...
export { ICanBuildAndRegisterAnEmbedding } from './ICanBuildAndRegisterAnEmbedding';
