...
describeThis(__filename, () => {
    ...
    it('should have the correct identifier', () => result.identifier.equals(new ScopedProjectionId(ProjectionId.from('88ae51ba-91fb-4168-990c-50d153804d42'), ScopeId.from('01f18113-25e6-4912-8572-7f17a291d6a5'))));
});
