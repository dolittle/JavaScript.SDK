...
describeThis(__filename, () => {
    ...
    it('should have the correct identifier', () => result.identifier.equals(new ScopedProjectionId(ProjectionId.from('268ac4a4-a6f0-4a3c-90b0-4adf37dacdf3'), ScopeId.from('4f49868b-690a-40c0-b351-2c7fd3d72c0b'))));
});
